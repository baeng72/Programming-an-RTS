...
private:
	BONE* m_pSrcBone;	//Bone to follow during Phase 1
	float m_speed;	//Speed of fireball
	float m_length;	//Distance to target
	float m_prc;		//Percentage of path complete		
	TRANSFORM m_t1;	//fireball transformation
