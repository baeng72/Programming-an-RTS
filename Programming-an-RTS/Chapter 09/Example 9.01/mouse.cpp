...
void MOUSE::Init(Renderer::RenderDevice* pdevice,  std::shared_ptr<Renderer::ShaderManager>& shaderManager,Core::Window* pwindow) {
	...
	std::unique_ptr<Renderer::Image> image = std::unique_ptr<Renderer::Image>(Renderer::Image::Create("../../../../Resources/Chapter 09/Example 9.01/cursor/cursor.png"));
	...
	if (Core::GetAPI() == Core::API::Vulkan) {
		_sphereShader = std::unique_ptr<Renderer::Shader>(Renderer::Shader::Create(pdevice, shaderManager->CreateShaderData("../../../../Resources/Chapter 09/Example 9.01/shaders/Vulkan/shape.glsl", false)));
	}
	else {
		_sphereShader = std::unique_ptr<Renderer::Shader>(Renderer::Shader::Create(pdevice, shaderManager->CreateShaderData("../../../../Resources/Chapter 09/Example 9.01/shaders/GL/shape.glsl", false)));
	}
}
