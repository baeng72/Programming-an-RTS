...
{
	if (Core::ResourcePath::ProjectResourcePathExists(Core::ResourcePath::GetProjectResourcePath("textures/lightmap.jpg"))) {
		_lightMap.reset(Renderer::Texture::Create(_pdevice, Core::ResourcePath::GetProjectResourcePath("textures/lightmap.jpg")));
	}
	else {
...
void TERRAIN::RenderFogOfWar(PLAYER* player) {
	...
	}
	{
		...
		//visitedTexture->SaveToFile(Core::ResourcePath::GetTexturePath("visited.jpg"));
