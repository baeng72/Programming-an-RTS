...
bool LoadObjectResources(Renderer::RenderDevice* pdevice,std::shared_ptr<Renderer::ShaderManager> shaderManager) {
	MESH* tree = new MESH(pdevice, shaderManager, "../../../../Resources/Chapter 04/Example 4.13/meshes/tree.x");
	objectMeshes.push_back(tree);
	MESH* stone = new MESH(pdevice, shaderManager, "../../../../Resources/Chapter 04/Example 4.13/meshes/stone.x");
