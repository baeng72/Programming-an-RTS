...
bool APPLICATION::Init(int width, int height, const char* title) {
	...
	_light.direction = glm::vec3(0.f, -1.f, 0.f);
	return true;
}
...
void APPLICATION::Render() {	
	...
	_font->Draw("W: Toggle Wireframe", 10, 10);
	_font->Draw("+/-: Zoom In/Out", 10, 30);
	_font->Draw("SPACE: Randomize Terrain", 10, 50);
	_font->Draw("UP/DOWN: Increate/Decrease Number of Patches", 10, 70);
	_font->Draw("F: Load HeighMap from File", 10, 90);
